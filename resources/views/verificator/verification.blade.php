...
@section('content')
    ...
    <div class="glass rounded-2xl shadow-xl p-8 animate-fade-in">
        ...
        <div class="mb-8 text-center">
            ...
            <h2 class="text-3xl font-bold text-gray-900 mb-2">Form Verifikasi TUK</h2>
            <p class="text-gray-600">STANDAR PERSYARATAN JABATAN KERJA</p>
        </div>
            ...
            <div class="bg-white rounded-xl p-6 border border-gray-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <div class="flex items-center p-3 rounded-lg border border-gray-200 hover:bg-gray-50 transition-colors">
                        ...
                        <label for="gedung" class="ml-3 block text-sm font-medium text-gray-700 cursor-pointer">
                    ...
                    <div class="flex items-center p-3 rounded-lg border border-gray-200 hover:bg-gray-50 transition-colors">
                        ...
                        <label for="bangunan" class="ml-3 block text-sm font-medium text-gray-700 cursor-pointer">
                    ...
                    <div class="flex items-center p-3 rounded-lg border border-gray-200 hover:bg-gray-50 transition-colors">
                        ...
                        <label for="ruangan" class="ml-3 block text-sm font-medium text-gray-700 cursor-pointer">
                    ...
                    <div class="flex items-center p-3 rounded-lg border border-gray-200 hover:bg-gray-50 transition-colors">
                        ...
                        <label for="internet" class="ml-3 block text-sm font-medium text-gray-700 cursor-pointer">
        ...
        <div class="flex items-center justify-center min-h-screen p-4">
            <div class="bg-white rounded-2xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-hidden">
                <div class="flex items-center justify-between p-4 border-b">
                    <h3 class="text-lg font-semibold text-gray-900">Preview Panduan Peralatan</h3>
