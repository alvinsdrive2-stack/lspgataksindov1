...
@section('title', 'Login Direktur')

@section('roleBadge')
    <div class="inline-flex items-center px-6 py-3 bg-white/10 backdrop-blur rounded-full border border-white/20">
        <svg class="w-6 h-6 text-red-400 mr-3" fill="currentColor" viewBox="0 0 24 24">
            <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/>
        </svg>
        <span class="text-white font-semibold">Direktur LSP</span>
    </div>
@endsection

@section('content')
    <div class="text-center mb-8">
        <h2 class="text-3xl font-bold text-white mb-2">Login Direktur LSP</h2>
        <p class="text-blue-200">Masuk untuk approval dan oversight</p>
    </div>
