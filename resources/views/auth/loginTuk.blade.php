...
@section('roleBadge')
    <div class="inline-flex items-center px-6 py-3 bg-white/10 backdrop-blur rounded-full border border-white/20">
        ...
        <span class="text-white font-semibold">Ketua TUK</span>
    </div>
@endsection

@section('content')
    <div class="text-center mb-8">
        <h2 class="text-3xl font-bold text-white mb-2">Login Ketua TUK</h2>
        <p class="text-blue-200">Masuk untuk manajemen TUK</p>
    </div>
